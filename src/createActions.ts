...
export interface FetchSuccessAction<Resource> {
  entity: string
  type: 'FETCH_SUCCESS'
  payload: {
...
export interface FetchSuccessIgnoreAction<Resource> {
  entity: string
...
export interface UpdateStartAction<Resource> {
  entity: string
  type: 'UPDATE_START'
  payload: { id?: string | string; data: Resource | any }
}

export interface UpdateSuccessAction<Resource> {
  entity: string
  type: 'UPDATE_SUCCESS'
...
const createActions = <Resource>(entityName: string) => {
  ...
  const fetchErrorAction = (error: string, ids?: string | string[]): FetchErrorAction => ({
    entity: entityName,
    type: FETCH_ERROR,
  ...
  const updateSuccessAction = (id: string, data?: Resource): UpdateSuccessAction<Resource> => ({
    entity: entityName,
    type: UPDATE_SUCCESS,
